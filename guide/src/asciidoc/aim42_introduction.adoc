...
[NOTE] 
--
Within aim42 we call the system to be improved (maintained, enhanced, optimized) _System under Design (SuD)_, as this term is common within the software architecture community.

A system under design (SuD) can comprise software, hardware and organizational or business processes related to the system, its management, development, maintenance or operation.
--
