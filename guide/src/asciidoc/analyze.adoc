...
* Architecture Analysis, see [pattern]#<<Qualitative-Analysis>># and
[pattern]#<<ATAM>>#.
...
* [pattern]#<<Questionnaire>>#, especially [pattern]#<<Pre-Interview-Questionnaire>>#
* [pattern]#<<Requirements-Analysis>>#
* [pattern]#<<Root-Cause-Analysis>># - finding the root cause of problems
...
* [pattern]#<<Static-Code-Analysis>># (Structural analysis)
* [pattern]#<<Structural-Analysis>>#
* [pattern]#<<Take-What-They-Mean>># (not what they say, as it may differ).
