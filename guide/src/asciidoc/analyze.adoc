...
. Begin with <<Stakeholder-Analysis>>, then conduct <<Stakeholder-Interview>> 
...
. Perform <<Runtime-Analysis>>, e.g. performance and load monitoring, process and thread analysis
