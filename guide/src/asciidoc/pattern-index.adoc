...
Architecture Documentation:: See <<System-Documentation, System Documentation>> and <<View-Based-Understanding, View Based Understanding>>.
Category: <<Analyze>>
+
...
+
Part of <<ATAM, ATAM>>, Capture and document specific quality requirements. Specialisation of <<Requirements-Analysis, Requirements Analysis>>. 
Category: <<Analyze>>
+
...
. [[Dependency-Analysis]]
Dependency Analysis:: See <<Structural-Analysis, Structural Analysis>>.
Category: <<Analyze>>
+
...
Hierarchical Quality Model:: Decompose the overall goal of "high quality" into more detailed and precise requirements, finally resulting in a tree-like structure. See <<ATAM, ATAM>> and <<Quality-Requirements, Quality Requirements>>.
Category: <<Analyze>>
+
...
<<Explicit-Assumption, assumtions explicit>> and expand on <<Runtime-Analysis, Runtime Analysis>> and 
...
is changed. Usable in situations where a <<Refactoring-Plan, Refactoring Plan>> is not feasible or in
...
. [[Keep-Data-Toss-Code]]
Keep Data Toss Code:: A strategy to improve systems, keeping the data created with the (old) systems as foundation for a new one. Also described as <<Keller-Migration, Bridge-to-the-New-Town>> (by Wolfgang Keller). This is the opposite of <<Never-Change-Running-System, Never Change Running System>>.
Category: <<Improve>>
+
...
+
See <<Quality-Requirements, Quality Requirements>>.
Category: <<Analyze>>
+

. [[Quality-Driven-Software-Architecture]]
Quality Driven Software Architecture (QDSA):: Derive (technical, structural or process-related) decisions based upon detailed quality requirements. QDSA requires <<Capture-Quality-Requirements, explicit quality requirements>>. See <<Quality-Function-Deployment, Quality Function Deployment>>.
Category: <<Improve>>
+

. [[Quality-Function-Deployment]]
Quality Function Deployment:: (QFD) Systematically translate customer requirements into technical requirements for  system development and maintenance. See <<Quality-Driven-Software-Architecture, Quality Driven Software Architecture>>.
+
...
. [[Questionnaire]]
Questionnaire:: Written collection of questions presented to stakeholders. Can be addendum, preparation or replacement of <<Stakeholder-Interview, Stakeholder Interview>>.
Category: <<Analyze>>
+
...
Remove Nested Control Structures:: Re-structure code so that deeply nested or complicated control structures are replaced by semantically identical versions. Special case of <<Refactoring, Refactoring>>, similar to <<Untangle-Code, Untangle Code>>.
Category: <<Improve>>
+
...
. [[Runtime-Analysis]]
Runtime Analysis:: See <<Profiling, Profiling>>, <<Performance-Analysis, Performance Analysis>>.
Category: <<Analyze>>
+
...
. [[Untangle-Code]]
Untangle Code:: Remove unneccessary complications in code, e.g. nested structures, dependencies, dead-code, duplicate-code etc. See <<Remove-Nested-Control-Structures, Remove Nested Control Structures>>. Special case of <<Refactoring, Refactoring>>.
Category: <<Improve>>
+
