...
<map name="EvaluationPractices">
	...
	<area shape=rect coords="214,11,270,54" href="#Estimate-Issue-Cost">
	<area shape=rect coords="351,65,426,108" href="#Estimate-Improvement-Cost">
	<area shape=rect coords="58,65,133,108" href="#Estimate-Issue-Cost">
</map>
