...
[NOTE]
--
http://aim42.org[aim42] is a collection of practices and patterns to support software evolution, maintenance, migration and improvement of software systems:
