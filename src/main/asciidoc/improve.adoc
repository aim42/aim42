...
[horizontal]
<<Fundamentals>>:: Some principles which you should consider whatever steps you take
on your road to improvement.
<<Approaches>>:: Overall decisions how to tackle improvement. Examples include *Big-Bang*, *Strangulate-Bad-Parts*, *Change-Via-Split*.  
<<improve-practices, Practices>>:: fine-grained practices or patterns, structured in several <<categories>>.
...
// Describe meaning/definitino of categories

[[Determine-Improvement-Approach]]
===== Determine Improvement Approach
...
// TODO: add sections for other categories and describe
