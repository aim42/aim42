...
usually in smaller scales with reasonable risks. Helps to get [Fast-Feedback] 
...
image::improve-patterns-concepts.png["improvement-categories", title="Improvement Categories"]
