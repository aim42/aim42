...
|Issue (problem) | 
Any problem, error, fault or suboptimal situation within the <<System>> processes related to it (e.g. management, development, administrative or organizational process).
