...
image::cost-of-change.jpg["target situation", 50%, title="Reality: Maintaining software is too expensive"]
...
image::target-situation.jpg["target situation", 50%, title="Goal: Maintainable Software"]
