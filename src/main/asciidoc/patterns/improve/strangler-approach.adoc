...
1) with adding new features and 2) without adding new features. Deciding to go for the first strategy means that you can still keep your business happy, because you still able to
