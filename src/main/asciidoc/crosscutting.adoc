...
<area shape=rect coords="199,174,302,228" href="#Collect-Issues">
</map>
...
You should constantly watch out for issues (problems and risks).
Keep a list of those issues. Regularly match those to your
