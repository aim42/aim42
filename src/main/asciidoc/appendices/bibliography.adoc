...
* [[[Tornhill-XRay]]] Adam Tornhill: https://pragprog.com/book/atevol/software-design-x-rays[Software Design X-Rays: Fix Technical Debt with Behavioral Code Analysis]. Pragmatic Programmers, 2018. This book focuses on the social behavior of software developers. It shows how you can spot knowledge loss, hidden change dependencies and hot spots of bad code.